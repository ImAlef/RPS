...
{
    [CreateAssetMenu(menuName = "Holder/ObjectHolder", fileName = "New ObjectHolder")]
    public class ObjectHolder : HolderObject
    {
        private List<BaseMatrixSlot> _matrices;
        public override object[] Objects { get => objects; set => objects = (Object[])value; }
        ...
        public override void CreateSort()
        {
            ...
            {
               _matrices.Add(new BaseMatrixSlot(obj.name));
            }
        }
